...
insert into dish(id, name, location_name, longitude, latitude, image, user_id, description) values(1000, 'Spaghetti Bolognese', 'Le Pastafarian', '50.849903', '4.725381', 'images/spaghetti.jpg', 10, "Classic Italian dish and very simple to make, this is a guaranteed success for both children and grown ups alike!");
insert into dish(id, name, location_name, longitude, latitude, image, user_id, description) values(2000, 'Salade Nicoise met verse tonijn', 'French Connection', '50.849903', '4.725381', 'images/salade-nicoise.jpg', 20, "Met deze beroemde salade uit Nice proef je de zuiderse sfeer van de Promenade des Anglais in Nice op je bord. Er bestaan talloze versies van deze salade en dit is er eentje van.");
insert into dish(id, name, location_name, longitude, latitude, image, user_id, description) values(3000, 'Eggs Benedict', 'English Breakfast', '50.849903', '4.725381', 'images/eggs-benedict.jpg', 30, "Eieren zijn niet duur en kun je bij heel veel bereidingen gebruiken. Scharreleieren komen van kippen die los lopen in een stal. Eieren van vrije uitloop komen van kippen die buiten mogen rondlopen. Je mag een ei tot vier weken nadat het gelegd is gebruiken.Eggs Benedict is een typisch Amerikaans ontbijt van toast met een gepocheerd ei, Hollandaisesaus en krokant spek.");
insert into dish(id, name, location_name, longitude, latitude, image, user_id, description) values(4000, 'Asperges op vlaamse wijze', 'De zoute zoen', '50.849903', '4.725381', 'images/asperges-opvlaamsewijze.jpg', 40, "De lente, das hét seizoen voor asperges. Beter dan nu zal je het witte goud niet vinden. De klassieke bereiding op z'n Vlaams, met ingrediënten die zacht zijn van smaak, laat de groente volledig tot z'n recht komen.");
